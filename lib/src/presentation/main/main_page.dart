...
import 'package:contact_auth_bloc/src/presentation/contact/home/home_page.dart';
...
import 'package:contact_auth_bloc/src/presentation/profile/profile/profile_page.dart';
    ...
    switch (index) {
      case 0:
        return BlocListener<HomeCubit, HomeState>(
          ...
          listener: (context, state) {
            controller.changeBottomNavigator(
              isHide: state is HomeLoadingState || state is HomeErrorState,
              pageIndex: index,
            );
          },
      ...
      case 1:
        return BlocListener<ProfileCubit, ProfileState>(
          ...
          listener: (context, state) {
            controller.changeBottomNavigator(
              isHide: state is ProfileUpdateUserLoadingState || state is ProfileUserErrorState,
              pageIndex: index,
            );
          },
      ...
      default:
        return BlocListener<HomeCubit, HomeState>(
          ...
          listener: (context, state) {
            controller.changeBottomNavigator(
              isHide: state is HomeLoadingState,
              pageIndex: index,
            );
          },
          child: HomePage(controller: homeController),
